...
// Public submit: simpan pendaftaran
$routes->post('daftar/submit', 'Home::daftarSubmit');
...
$routes->group('admin', ['filter' => ['login', 'idle']], function ($routes) {
    ...
    // Sertifikat: Update editable fields (status, tanggal terbit, nama kelas)
    $routes->post('sertifikat/update', 'Admin\Sertifikat::update');
